...
export function MyPage(user:mypageProps){
    return(<div>
        <div className={styles.MypageHeader}>마이 페이지</div>
        ...
        <button className={styles.MypageBox}><img src= "img/mypagebabyak.svg"/>
            <span className={styles.MypageInfo}>나의 밥약 횟수</span>
            <span className={styles.MypageContent}>{user.babyak}</span></button>
        <button className={styles.MypageBox}><img src= "img/mypagenoshow.svg"/>
            <span className={styles.MypageInfo}>밥약 노쇼 횟수</span>
            <span className={styles.MypageContent}>{user.noshow}</span></button>
        <button className={styles.MypageBox}><img src= "img/mypageheart.svg"/>
            <span className={styles.MypageInfo}>내가 찜한 게시글</span></button>
        <button className={styles.MypageBox}><img src= "img/mypagetimetable.svg"/>
            <span className={styles.MypageInfo}>나의 시간표</span>
            <div><img src= "img/timetable.png"/></div>
            </button>
    <MenuFooter  type={2}/>
    </div>)
}
